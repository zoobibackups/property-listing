              ...
              <v-row class="d-flex justify-center align-center" style="margin-top: 25px">
               <h3>{{propertyDetails?.property_address}}</h3>
                <v-col md="12" class="d-flex justify-center align-center">
                 ...
                 <v-img src="https://api.propelinspections.com/inventory/uploads/my_default_img.jpg" height="300" width="300"
                      lazy-src="https://api.propelinspections.com/inventory/uploads/my_default_img.jpg" contain ></v-img>
                
                </v-col>
                 <v-col cols="12" class="d-flex justify-center align-center">
                 <template>
                  <v-table density="compact" height="300px" width="300px">
                      <thead>
                      <tr>
                        <th class="text-left">
                          Name
                    ...
                    <tbody>
                      <tr>
                        <td>Inspected By</td>
                        <td style="margin-left: 25px">{{ propertyDetails?.inspector_name }}</td>
                      </tr>
                      <tr>
                        <td>Tenant’s Name</td>
